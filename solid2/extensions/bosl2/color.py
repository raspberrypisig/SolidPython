...
class recolor(OpenSCADObject, Bosl2Mixin):
    def __init__(self, c=None, **kwargs):
       super().__init__("recolor", {"c" : c, **kwargs})

class color_this(OpenSCADObject, Bosl2Mixin):
    def __init__(self, c=None, **kwargs):
       super().__init__("color_this", {"c" : c, **kwargs})

class rainbow(OpenSCADObject, Bosl2Mixin):
