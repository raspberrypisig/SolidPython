...
class region(OpenSCADObject, Bosl2Mixin):
...
class exclusive_or(OpenSCADObject, Bosl2Mixin):
    def __init__(self, **kwargs):
       super().__init__("exclusive_or", {**kwargs})

class is_region(OpenSCADObject, Bosl2Mixin):
    def __init__(self, x=None, **kwargs):
       super().__init__("is_region", {"x" : x, **kwargs})

class is_valid_region(OpenSCADObject, Bosl2Mixin):
    def __init__(self, region=None, eps=None, **kwargs):
       super().__init__("is_valid_region", {"region" : region, "eps" : eps, **kwargs})

class _polygon_crosses_region(OpenSCADObject, Bosl2Mixin):
...
class is_region_simple(OpenSCADObject, Bosl2Mixin):
    def __init__(self, region=None, eps=None, **kwargs):
       super().__init__("is_region_simple", {"region" : region, "eps" : eps, **kwargs})

class make_region(OpenSCADObject, Bosl2Mixin):
...
class force_region(OpenSCADObject, Bosl2Mixin):
    def __init__(self, poly=None, **kwargs):
       super().__init__("force_region", {"poly" : poly, **kwargs})

class point_in_region(OpenSCADObject, Bosl2Mixin):
...
class _point_in_region(OpenSCADObject, Bosl2Mixin):
...
class __are_regions_equal(OpenSCADObject, Bosl2Mixin):
...
class _region_region_intersections(OpenSCADObject, Bosl2Mixin):
...
class split_region_at_region_crossings(OpenSCADObject, Bosl2Mixin):
    def __init__(self, region1=None, region2=None, closed1=None, closed2=None, eps=None, **kwargs):
...
class region_parts(OpenSCADObject, Bosl2Mixin):
    def __init__(self, region=None, **kwargs):
       super().__init__("region_parts", {"region" : region, **kwargs})

class _offset_chamfer(OpenSCADObject, Bosl2Mixin):
...
class _makefaces_recurse(OpenSCADObject, Bosl2Mixin):
...
class _good_segments(OpenSCADObject, Bosl2Mixin):
...
class _segment_good(OpenSCADObject, Bosl2Mixin):
...
class _point_dist(OpenSCADObject, Bosl2Mixin):
...
class offset(OpenSCADObject, Bosl2Mixin):
...
class _filter_region_parts(OpenSCADObject, Bosl2Mixin):
