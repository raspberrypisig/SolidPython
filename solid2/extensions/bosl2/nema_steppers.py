...
class nema_motor_width(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, size=None, **kwargs):
       super().__init__("nema_motor_width", {"size" : size, **kwargs})

class nema_motor_plinth_height(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, size=None, **kwargs):
       super().__init__("nema_motor_plinth_height", {"size" : size, **kwargs})

class nema_motor_plinth_diam(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, size=None, **kwargs):
       super().__init__("nema_motor_plinth_diam", {"size" : size, **kwargs})

class nema_motor_screw_spacing(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, size=None, **kwargs):
       super().__init__("nema_motor_screw_spacing", {"size" : size, **kwargs})

class nema_motor_screw_size(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, size=None, **kwargs):
       super().__init__("nema_motor_screw_size", {"size" : size, **kwargs})

class nema_motor_screw_depth(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, size=None, **kwargs):
       super().__init__("nema_motor_screw_depth", {"size" : size, **kwargs})

class nema11_stepper(_OpenSCADObject, _Bosl2Mixin):
...
class nema11_mount_holes(_OpenSCADObject, _Bosl2Mixin):
