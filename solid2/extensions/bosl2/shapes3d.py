...
class cube(OpenSCADObject, Bosl2Mixin):
...
class cuboid(OpenSCADObject, Bosl2Mixin):
...
class prismoid(OpenSCADObject, Bosl2Mixin):
...
class octahedron(OpenSCADObject, Bosl2Mixin):
...
class rect_tube(OpenSCADObject, Bosl2Mixin):
...
class cyl(OpenSCADObject, Bosl2Mixin):
...
class xcyl(OpenSCADObject, Bosl2Mixin):
...
class ycyl(OpenSCADObject, Bosl2Mixin):
    def __init__(self, h=None, r=None, d=None, r1=None, r2=None, d1=None, d2=None, l=None, chamfer=None, chamfer1=None, chamfer2=None, chamfang=None, chamfang1=None, chamfang2=None, rounding=None, rounding1=None, rounding2=None, circum=None, realign=None, from_end=None, anchor=None, spin=None, orient=None, **kwargs):
...
class zcyl(OpenSCADObject, Bosl2Mixin):
    def __init__(self, h=None, r=None, d=None, r1=None, r2=None, d1=None, d2=None, l=None, chamfer=None, chamfer1=None, chamfer2=None, chamfang=None, chamfang1=None, chamfang2=None, rounding=None, rounding1=None, rounding2=None, circum=None, realign=None, from_end=None, anchor=None, spin=None, orient=None, **kwargs):
...
class tube(OpenSCADObject, Bosl2Mixin):
...
class pie_slice(OpenSCADObject, Bosl2Mixin):
...
class sphere(OpenSCADObject, Bosl2Mixin):
...
class spheroid(OpenSCADObject, Bosl2Mixin):
...
class torus(OpenSCADObject, Bosl2Mixin):
...
class teardrop(OpenSCADObject, Bosl2Mixin):
...
class onion(OpenSCADObject, Bosl2Mixin):
...
class text3d(OpenSCADObject, Bosl2Mixin):
...
class path_text(OpenSCADObject, Bosl2Mixin):
...
class interior_fillet(OpenSCADObject, Bosl2Mixin):
...
class heightfield(OpenSCADObject, Bosl2Mixin):
...
class cylindrical_heightfield(OpenSCADObject, Bosl2Mixin):
...
class ruler(OpenSCADObject, Bosl2Mixin):
...
class _subsample_triangle(OpenSCADObject, Bosl2Mixin):
    def __init__(self, p=None, N=None, **kwargs):
       super().__init__("_subsample_triangle", {"p" : p, "N" : N, **kwargs})

class _dual_vertices(OpenSCADObject, Bosl2Mixin):
...
class _cut_interp(OpenSCADObject, Bosl2Mixin):
