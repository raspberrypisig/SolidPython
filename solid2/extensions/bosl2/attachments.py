...
class edge_profile(OpenSCADObject, Bosl2Mixin):
...
class corner_profile(OpenSCADObject, Bosl2Mixin):
...
class attachable(OpenSCADObject, Bosl2Mixin):
...
class _show_corners(OpenSCADObject, Bosl2Mixin):
...
class _show_cube_faces(OpenSCADObject, Bosl2Mixin):
...
class reorient(OpenSCADObject, Bosl2Mixin):
...
class named_anchor(OpenSCADObject, Bosl2Mixin):
...
class attach_geom(OpenSCADObject, Bosl2Mixin):
...
class _attach_geom_2d(OpenSCADObject, Bosl2Mixin):
    def __init__(self, geom=None, **kwargs):
       super().__init__("_attach_geom_2d", {"geom" : geom, **kwargs})

class _attach_geom_size(OpenSCADObject, Bosl2Mixin):
    def __init__(self, geom=None, **kwargs):
       super().__init__("_attach_geom_size", {"geom" : geom, **kwargs})

class _attach_transform(OpenSCADObject, Bosl2Mixin):
