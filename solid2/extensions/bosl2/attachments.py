...
class reorient(_OpenSCADObject, _Bosl2Mixin):
...
class named_anchor(_OpenSCADObject, _Bosl2Mixin):
...
class attach_geom(_OpenSCADObject, _Bosl2Mixin):
...
class _attach_geom_2d(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, geom=None, **kwargs):
       super().__init__("_attach_geom_2d", {"geom" : geom, **kwargs})

class _attach_geom_size(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, geom=None, **kwargs):
       super().__init__("_attach_geom_size", {"geom" : geom, **kwargs})

class _attach_transform(_OpenSCADObject, _Bosl2Mixin):
...
class edge_profile(_OpenSCADObject, _Bosl2Mixin):
...
class corner_profile(_OpenSCADObject, _Bosl2Mixin):
...
class attachable(_OpenSCADObject, _Bosl2Mixin):
...
class _show_corners(_OpenSCADObject, _Bosl2Mixin):
...
class _show_cube_faces(_OpenSCADObject, _Bosl2Mixin):
