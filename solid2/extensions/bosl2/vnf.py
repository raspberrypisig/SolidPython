...
class vnf_polyhedron(OpenSCADObject, Bosl2Mixin):
...
class debug_vnf(OpenSCADObject, Bosl2Mixin):
...
class vnf_validate(OpenSCADObject, Bosl2Mixin):
...
class vnf_vertex_array(OpenSCADObject, Bosl2Mixin):
...
class vnf_tri_array(OpenSCADObject, Bosl2Mixin):
...
class _slice_3dpolygons(OpenSCADObject, Bosl2Mixin):
...
class vnf_volume(OpenSCADObject, Bosl2Mixin):
    def __init__(self, vnf=None, **kwargs):
       super().__init__("vnf_volume", {"vnf" : vnf, **kwargs})

class vnf_area(OpenSCADObject, Bosl2Mixin):
    def __init__(self, vnf=None, **kwargs):
       super().__init__("vnf_area", {"vnf" : vnf, **kwargs})

class _vnf_centroid(OpenSCADObject, Bosl2Mixin):
    def __init__(self, vnf=None, eps=None, **kwargs):
       super().__init__("_vnf_centroid", {"vnf" : vnf, "eps" : eps, **kwargs})

class vnf_halfspace(OpenSCADObject, Bosl2Mixin):
...
class _assemble_paths(OpenSCADObject, Bosl2Mixin):
...
class _vnfcut(OpenSCADObject, Bosl2Mixin):
...
class _triangulate_planar_convex_polygons(OpenSCADObject, Bosl2Mixin):
    def __init__(self, polys=None, **kwargs):
       super().__init__("_triangulate_planar_convex_polygons", {"polys" : polys, **kwargs})

class vnf_bend(OpenSCADObject, Bosl2Mixin):
...
class _edge_not_reported(OpenSCADObject, Bosl2Mixin):
