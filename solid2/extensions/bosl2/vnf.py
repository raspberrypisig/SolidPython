...
class vnf_vertex_array(_OpenSCADObject, _Bosl2Mixin):
...
class vnf_tri_array(_OpenSCADObject, _Bosl2Mixin):
...
class _slice_3dpolygons(_OpenSCADObject, _Bosl2Mixin):
...
class vnf_volume(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, vnf=None, **kwargs):
       super().__init__("vnf_volume", {"vnf" : vnf, **kwargs})

class vnf_area(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, vnf=None, **kwargs):
       super().__init__("vnf_area", {"vnf" : vnf, **kwargs})

class _vnf_centroid(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, vnf=None, eps=None, **kwargs):
       super().__init__("_vnf_centroid", {"vnf" : vnf, "eps" : eps, **kwargs})

class vnf_halfspace(_OpenSCADObject, _Bosl2Mixin):
...
class _assemble_paths(_OpenSCADObject, _Bosl2Mixin):
...
class _vnfcut(_OpenSCADObject, _Bosl2Mixin):
...
class _edge_not_reported(_OpenSCADObject, _Bosl2Mixin):
...
class vnf_polyhedron(_OpenSCADObject, _Bosl2Mixin):
...
class debug_vnf(_OpenSCADObject, _Bosl2Mixin):
