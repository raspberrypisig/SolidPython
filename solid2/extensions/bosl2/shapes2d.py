...
class square(_OpenSCADObject, _Bosl2Mixin):
...
class rect(_OpenSCADObject, _Bosl2Mixin):
...
class circle(_OpenSCADObject, _Bosl2Mixin):
...
class ellipse(_OpenSCADObject, _Bosl2Mixin):
...
class regular_ngon(_OpenSCADObject, _Bosl2Mixin):
...
class pentagon(_OpenSCADObject, _Bosl2Mixin):
...
class hexagon(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, r=None, d=None, _or=None, od=None, ir=None, id=None, side=None, rounding=None, realign=None, align_tip=None, align_side=None, anchor=None, spin=None, **kwargs):
...
class octagon(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, r=None, d=None, _or=None, od=None, ir=None, id=None, side=None, rounding=None, realign=None, align_tip=None, align_side=None, anchor=None, spin=None, **kwargs):
...
class right_triangle(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, size=None, center=None, anchor=None, spin=None, **kwargs):
       super().__init__("right_triangle", {"size" : size, "center" : center, "anchor" : anchor, "spin" : spin, **kwargs})

class trapezoid(_OpenSCADObject, _Bosl2Mixin):
...
class star(_OpenSCADObject, _Bosl2Mixin):
...
class _path_add_jitter(_OpenSCADObject, _Bosl2Mixin):
...
class teardrop2d(_OpenSCADObject, _Bosl2Mixin):
...
class egg(_OpenSCADObject, _Bosl2Mixin):
...
class glued_circles(_OpenSCADObject, _Bosl2Mixin):
...
class _superformula(_OpenSCADObject, _Bosl2Mixin):
...
class supershape(_OpenSCADObject, _Bosl2Mixin):
...
class reuleaux_polygon(_OpenSCADObject, _Bosl2Mixin):
...
class jittered_poly(_OpenSCADObject, _Bosl2Mixin):
...
class text(_OpenSCADObject, _Bosl2Mixin):
