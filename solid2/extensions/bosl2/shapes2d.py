...
class square(OpenSCADObject, Bosl2Mixin):
...
class rect(OpenSCADObject, Bosl2Mixin):
...
class circle(OpenSCADObject, Bosl2Mixin):
...
class ellipse(OpenSCADObject, Bosl2Mixin):
...
class regular_ngon(OpenSCADObject, Bosl2Mixin):
...
class pentagon(OpenSCADObject, Bosl2Mixin):
...
class hexagon(OpenSCADObject, Bosl2Mixin):
    def __init__(self, r=None, d=None, _or=None, od=None, ir=None, id=None, side=None, rounding=None, realign=None, align_tip=None, align_side=None, anchor=None, spin=None, **kwargs):
...
class octagon(OpenSCADObject, Bosl2Mixin):
    def __init__(self, r=None, d=None, _or=None, od=None, ir=None, id=None, side=None, rounding=None, realign=None, align_tip=None, align_side=None, anchor=None, spin=None, **kwargs):
...
class right_triangle(OpenSCADObject, Bosl2Mixin):
    def __init__(self, size=None, center=None, anchor=None, spin=None, **kwargs):
       super().__init__("right_triangle", {"size" : size, "center" : center, "anchor" : anchor, "spin" : spin, **kwargs})

class trapezoid(OpenSCADObject, Bosl2Mixin):
...
class star(OpenSCADObject, Bosl2Mixin):
...
class egg(OpenSCADObject, Bosl2Mixin):
...
class glued_circles(OpenSCADObject, Bosl2Mixin):
...
class supershape(OpenSCADObject, Bosl2Mixin):
...
class reuleaux_polygon(OpenSCADObject, Bosl2Mixin):
...
class text(OpenSCADObject, Bosl2Mixin):
...
class _path_add_jitter(OpenSCADObject, Bosl2Mixin):
...
class _superformula(OpenSCADObject, Bosl2Mixin):
