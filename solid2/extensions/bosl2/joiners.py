...
class half_joiner_clear(_OpenSCADObject, _Bosl2Mixin):
...
class half_joiner(_OpenSCADObject, _Bosl2Mixin):
...
class _pin_size(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, size=None, **kwargs):
       super().__init__("_pin_size", {"size" : size, **kwargs})

class snap_pin(_OpenSCADObject, _Bosl2Mixin):
...
class snap_pin_socket(_OpenSCADObject, _Bosl2Mixin):
...
class rabbit_clip(_OpenSCADObject, _Bosl2Mixin):
...
class _pin_shaft(_OpenSCADObject, _Bosl2Mixin):
