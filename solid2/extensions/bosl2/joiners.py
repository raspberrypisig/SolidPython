...
class half_joiner_clear(OpenSCADObject, Bosl2Mixin):
...
class half_joiner(OpenSCADObject, Bosl2Mixin):
...
class _pin_shaft(OpenSCADObject, Bosl2Mixin):
...
class snap_pin(OpenSCADObject, Bosl2Mixin):
...
class snap_pin_socket(OpenSCADObject, Bosl2Mixin):
...
class rabbit_clip(OpenSCADObject, Bosl2Mixin):
...
class _pin_size(OpenSCADObject, Bosl2Mixin):
