...
class cubetruss_segment(OpenSCADObject, Bosl2Mixin):
...
class cubetruss_support(OpenSCADObject, Bosl2Mixin):
...
class cubetruss_clip(OpenSCADObject, Bosl2Mixin):
...
class cubetruss_foot(OpenSCADObject, Bosl2Mixin):
...
class cubetruss_joiner(OpenSCADObject, Bosl2Mixin):
...
class cubetruss_uclip(OpenSCADObject, Bosl2Mixin):
...
class cubetruss(OpenSCADObject, Bosl2Mixin):
...
class cubetruss_corner(OpenSCADObject, Bosl2Mixin):
...
class cubetruss_dist(OpenSCADObject, Bosl2Mixin):
