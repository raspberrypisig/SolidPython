...
class mask2d_roundover(OpenSCADObject, Bosl2Mixin):
...
class mask2d_rabbet(OpenSCADObject, Bosl2Mixin):
...
class mask2d_dovetail(OpenSCADObject, Bosl2Mixin):
...
class mask2d_teardrop(OpenSCADObject, Bosl2Mixin):
...
class mask2d_ogee(OpenSCADObject, Bosl2Mixin):
