...
class debug_bezier(OpenSCADObject, Bosl2Mixin):
...
class debug_bezier_patches(OpenSCADObject, Bosl2Mixin):
...
class bezier_derivative(OpenSCADObject, Bosl2Mixin):
...
class bezier_length(OpenSCADObject, Bosl2Mixin):
...
class bezpath_curve(OpenSCADObject, Bosl2Mixin):
...
class bezpath_closest_point(OpenSCADObject, Bosl2Mixin):
...
class bezpath_length(OpenSCADObject, Bosl2Mixin):
...
class path_to_bezpath(OpenSCADObject, Bosl2Mixin):
...
class bezpath_close_to_axis(OpenSCADObject, Bosl2Mixin):
...
class bezpath_offset(OpenSCADObject, Bosl2Mixin):
...
class bez_end(OpenSCADObject, Bosl2Mixin):
    def __init__(self, pt=None, a=None, r=None, p=None, **kwargs):
       super().__init__("bez_end", {"pt" : pt, "a" : a, "r" : r, "p" : p, **kwargs})

class is_bezier_patch(OpenSCADObject, Bosl2Mixin):
    def __init__(self, x=None, **kwargs):
       super().__init__("is_bezier_patch", {"x" : x, **kwargs})

class bezier_patch_flat(OpenSCADObject, Bosl2Mixin):
...
class bezier_vnf(OpenSCADObject, Bosl2Mixin):
...
class bezier_vnf_degenerate_patch(OpenSCADObject, Bosl2Mixin):
...
class bezier_patch_normals(OpenSCADObject, Bosl2Mixin):
    def __init__(self, patch=None, u=None, v=None, **kwargs):
