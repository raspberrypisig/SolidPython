...
class bezier_derivative(_OpenSCADObject, _Bosl2Mixin):
...
class bezier_length(_OpenSCADObject, _Bosl2Mixin):
...
class bezpath_curve(_OpenSCADObject, _Bosl2Mixin):
...
class bezpath_closest_point(_OpenSCADObject, _Bosl2Mixin):
...
class bezpath_length(_OpenSCADObject, _Bosl2Mixin):
...
class path_to_bezpath(_OpenSCADObject, _Bosl2Mixin):
...
class bezpath_close_to_axis(_OpenSCADObject, _Bosl2Mixin):
...
class bezpath_offset(_OpenSCADObject, _Bosl2Mixin):
...
class bez_end(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, pt=None, a=None, r=None, p=None, **kwargs):
       super().__init__("bez_end", {"pt" : pt, "a" : a, "r" : r, "p" : p, **kwargs})

class is_bezier_patch(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, x=None, **kwargs):
       super().__init__("is_bezier_patch", {"x" : x, **kwargs})

class bezier_patch_flat(_OpenSCADObject, _Bosl2Mixin):
...
class bezier_vnf(_OpenSCADObject, _Bosl2Mixin):
...
class bezier_vnf_degenerate_patch(_OpenSCADObject, _Bosl2Mixin):
...
class bezier_patch_normals(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, patch=None, u=None, v=None, **kwargs):
       super().__init__("bezier_patch_normals", {"patch" : patch, "u" : u, "v" : v, **kwargs})

class debug_bezier(_OpenSCADObject, _Bosl2Mixin):
...
class debug_bezier_patches(_OpenSCADObject, _Bosl2Mixin):
