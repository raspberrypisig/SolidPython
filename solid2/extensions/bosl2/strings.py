...
class _str_find_first(OpenSCADObject, Bosl2Mixin):
...
class _str_find_last(OpenSCADObject, Bosl2Mixin):
...
class _str_cmp_recurse(OpenSCADObject, Bosl2Mixin):
...
class starts_with(OpenSCADObject, Bosl2Mixin):
    def __init__(self, str=None, pattern=None, **kwargs):
       super().__init__("starts_with", {"str" : str, "pattern" : pattern, **kwargs})

class ends_with(OpenSCADObject, Bosl2Mixin):
    def __init__(self, str=None, pattern=None, **kwargs):
       super().__init__("ends_with", {"str" : str, "pattern" : pattern, **kwargs})

class str_split(OpenSCADObject, Bosl2Mixin):
...
class _str_split_recurse(OpenSCADObject, Bosl2Mixin):
...
class _remove_empty_strs(OpenSCADObject, Bosl2Mixin):
    def __init__(self, list=None, **kwargs):
       super().__init__("_remove_empty_strs", {"list" : list, **kwargs})

class str_join(OpenSCADObject, Bosl2Mixin):
...
class str_replace_char(OpenSCADObject, Bosl2Mixin):
...
class format(OpenSCADObject, Bosl2Mixin):
    def __init__(self, fmt=None, vals=None, **kwargs):
       super().__init__("format", {"fmt" : fmt, "vals" : vals, **kwargs})

class is_lower(OpenSCADObject, Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
       super().__init__("is_lower", {"s" : s, **kwargs})

class is_upper(OpenSCADObject, Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
       super().__init__("is_upper", {"s" : s, **kwargs})

class is_digit(OpenSCADObject, Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
       super().__init__("is_digit", {"s" : s, **kwargs})

class is_hexdigit(OpenSCADObject, Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
       super().__init__("is_hexdigit", {"s" : s, **kwargs})

class is_letter(OpenSCADObject, Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
