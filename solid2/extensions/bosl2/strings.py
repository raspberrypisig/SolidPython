...
class _str_find_first(_OpenSCADObject, _Bosl2Mixin):
...
class _str_find_last(_OpenSCADObject, _Bosl2Mixin):
...
class _str_cmp_recurse(_OpenSCADObject, _Bosl2Mixin):
...
class starts_with(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, str=None, pattern=None, **kwargs):
       super().__init__("starts_with", {"str" : str, "pattern" : pattern, **kwargs})

class ends_with(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, str=None, pattern=None, **kwargs):
       super().__init__("ends_with", {"str" : str, "pattern" : pattern, **kwargs})

class str_split(_OpenSCADObject, _Bosl2Mixin):
...
class _str_split_recurse(_OpenSCADObject, _Bosl2Mixin):
...
class _remove_empty_strs(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, list=None, **kwargs):
       super().__init__("_remove_empty_strs", {"list" : list, **kwargs})

class str_join(_OpenSCADObject, _Bosl2Mixin):
...
class str_replace_char(_OpenSCADObject, _Bosl2Mixin):
...
class format(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, fmt=None, vals=None, **kwargs):
       super().__init__("format", {"fmt" : fmt, "vals" : vals, **kwargs})

class is_lower(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
       super().__init__("is_lower", {"s" : s, **kwargs})

class is_upper(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
       super().__init__("is_upper", {"s" : s, **kwargs})

class is_digit(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
       super().__init__("is_digit", {"s" : s, **kwargs})

class is_hexdigit(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
       super().__init__("is_hexdigit", {"s" : s, **kwargs})

class is_letter(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, s=None, **kwargs):
