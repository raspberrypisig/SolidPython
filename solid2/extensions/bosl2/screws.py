...
class screw(_OpenSCADObject, _Bosl2Mixin):
...
class _ISO_thread_tolerance(_OpenSCADObject, _Bosl2Mixin):
...
class _UTS_thread_tolerance(_OpenSCADObject, _Bosl2Mixin):
...
class _exact_thread_tolerance(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, d=None, P=None, **kwargs):
       super().__init__("_exact_thread_tolerance", {"d" : d, "P" : P, **kwargs})

class nut(_OpenSCADObject, _Bosl2Mixin):
...
class screw_info(_OpenSCADObject, _Bosl2Mixin):
...
class _screw_info_english(_OpenSCADObject, _Bosl2Mixin):
...
class _screw_info_metric(_OpenSCADObject, _Bosl2Mixin):
...
class _is_positive(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, x=None, **kwargs):
       super().__init__("_is_positive", {"x" : x, **kwargs})

class _validate_screw_spec(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, spec=None, **kwargs):
       super().__init__("_validate_screw_spec", {"spec" : spec, **kwargs})

class thread_specification(_OpenSCADObject, _Bosl2Mixin):
...
class _driver(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, spec=None, **kwargs):
       super().__init__("_driver", {"spec" : spec, **kwargs})

class _rod(_OpenSCADObject, _Bosl2Mixin):
