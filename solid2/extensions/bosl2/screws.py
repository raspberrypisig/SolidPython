...
class screw(OpenSCADObject, Bosl2Mixin):
...
class _driver(OpenSCADObject, Bosl2Mixin):
    def __init__(self, spec=None, **kwargs):
       super().__init__("_driver", {"spec" : spec, **kwargs})

class _rod(OpenSCADObject, Bosl2Mixin):
...
class nut(OpenSCADObject, Bosl2Mixin):
...
class screw_head(OpenSCADObject, Bosl2Mixin):
...
class _ISO_thread_tolerance(OpenSCADObject, Bosl2Mixin):
...
class _UTS_thread_tolerance(OpenSCADObject, Bosl2Mixin):
...
class _exact_thread_tolerance(OpenSCADObject, Bosl2Mixin):
...
class _parse_screw_name(OpenSCADObject, Bosl2Mixin):
    def __init__(self, name=None, **kwargs):
       super().__init__("_parse_screw_name", {"name" : name, **kwargs})

class _parse_drive(OpenSCADObject, Bosl2Mixin):
...
class screw_info(OpenSCADObject, Bosl2Mixin):
...
class _screw_info_english(OpenSCADObject, Bosl2Mixin):
...
class _screw_info_metric(OpenSCADObject, Bosl2Mixin):
...
class _is_positive(OpenSCADObject, Bosl2Mixin):
    def __init__(self, x=None, **kwargs):
       super().__init__("_is_positive", {"x" : x, **kwargs})

class _validate_screw_spec(OpenSCADObject, Bosl2Mixin):
    def __init__(self, spec=None, **kwargs):
       super().__init__("_validate_screw_spec", {"spec" : spec, **kwargs})

class thread_specification(OpenSCADObject, Bosl2Mixin):
