...
class turtle3d(OpenSCADObject, Bosl2Mixin):
...
class _transpart(OpenSCADObject, Bosl2Mixin):
    def __init__(self, T=None, **kwargs):
       super().__init__("_transpart", {"T" : T, **kwargs})

class _rotpart(OpenSCADObject, Bosl2Mixin):
    def __init__(self, T=None, **kwargs):
       super().__init__("_rotpart", {"T" : T, **kwargs})

class _turtle3d_state_valid(OpenSCADObject, Bosl2Mixin):
...
class _turtle3d_repeat(OpenSCADObject, Bosl2Mixin):
...
class _turtle3d_command_len(OpenSCADObject, Bosl2Mixin):
...
class _turtle3d(OpenSCADObject, Bosl2Mixin):
...
class _turtle3d_rotation(OpenSCADObject, Bosl2Mixin):
...
class _tupdate(OpenSCADObject, Bosl2Mixin):
...
class _turtle3d_command(OpenSCADObject, Bosl2Mixin):
...
class _turtle3d_list_command(OpenSCADObject, Bosl2Mixin):
