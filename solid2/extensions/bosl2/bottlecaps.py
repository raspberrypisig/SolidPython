...
class pco1810_neck(OpenSCADObject, Bosl2Mixin):
...
class pco1810_cap(OpenSCADObject, Bosl2Mixin):
...
class generic_bottle_cap(OpenSCADObject, Bosl2Mixin):
...
class bottle_adapter_neck_to_cap(OpenSCADObject, Bosl2Mixin):
...
class bottle_adapter_cap_to_cap(OpenSCADObject, Bosl2Mixin):
...
class bottle_adapter_neck_to_neck(OpenSCADObject, Bosl2Mixin):
...
class sp_neck(OpenSCADObject, Bosl2Mixin):
...
class _sp_thread_profile(OpenSCADObject, Bosl2Mixin):
...
class sp_diameter(OpenSCADObject, Bosl2Mixin):
