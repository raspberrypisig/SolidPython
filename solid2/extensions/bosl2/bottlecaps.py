...
class pco1810_neck(_OpenSCADObject, _Bosl2Mixin):
...
class pco1810_cap(_OpenSCADObject, _Bosl2Mixin):
...
class generic_bottle_cap(_OpenSCADObject, _Bosl2Mixin):
...
class bottle_adapter_neck_to_cap(_OpenSCADObject, _Bosl2Mixin):
...
class bottle_adapter_cap_to_cap(_OpenSCADObject, _Bosl2Mixin):
...
class bottle_adapter_neck_to_neck(_OpenSCADObject, _Bosl2Mixin):
...
class _sp_thread_profile(_OpenSCADObject, _Bosl2Mixin):
...
class sp_neck(_OpenSCADObject, _Bosl2Mixin):
...
class sp_diameter(_OpenSCADObject, _Bosl2Mixin):
