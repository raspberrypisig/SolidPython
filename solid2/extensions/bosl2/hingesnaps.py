...
class apply_folding_hinges_and_snaps(OpenSCADObject, Bosl2Mixin):
...
class folding_hinge_mask(OpenSCADObject, Bosl2Mixin):
...
class snap_lock(OpenSCADObject, Bosl2Mixin):
...
class snap_socket(OpenSCADObject, Bosl2Mixin):
    def __init__(self, thick=None, snaplen=None, snapdiam=None, layerheight=None, foldangle=None, hingegap=None, anchor=None, spin=None, orient=None, **kwargs):
