...
class get_radius(_OpenSCADObject, _Bosl2Mixin):
...
class assert_equal(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, got=None, expected=None, info=None, **kwargs):
       super().__init__("assert_equal", {"got" : got, "expected" : expected, "info" : info, **kwargs})

class shape_compare(_OpenSCADObject, _Bosl2Mixin):
