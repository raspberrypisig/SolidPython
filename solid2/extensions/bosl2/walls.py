...
class sparse_wall(OpenSCADObject, Bosl2Mixin):
...
class corrugated_wall(OpenSCADObject, Bosl2Mixin):
...
class thinning_wall(OpenSCADObject, Bosl2Mixin):
...
class thinning_triangle(OpenSCADObject, Bosl2Mixin):
...
class narrowing_strut(OpenSCADObject, Bosl2Mixin):
