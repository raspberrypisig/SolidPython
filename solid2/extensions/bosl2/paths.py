...
class path_merge_collinear(OpenSCADObject, Bosl2Mixin):
...
class resample_path(OpenSCADObject, Bosl2Mixin):
...
class is_path_simple(OpenSCADObject, Bosl2Mixin):
    def __init__(self, path=None, closed=None, eps=None, **kwargs):
       super().__init__("is_path_simple", {"path" : path, "closed" : closed, "eps" : eps, **kwargs})

class path_closest_point(OpenSCADObject, Bosl2Mixin):
...
class path_tangents(OpenSCADObject, Bosl2Mixin):
...
class path_normals(OpenSCADObject, Bosl2Mixin):
...
class path_curvature(OpenSCADObject, Bosl2Mixin):
    def __init__(self, path=None, closed=None, **kwargs):
       super().__init__("path_curvature", {"path" : path, "closed" : closed, **kwargs})

class path_torsion(OpenSCADObject, Bosl2Mixin):
    def __init__(self, path=None, closed=None, **kwargs):
       super().__init__("path_torsion", {"path" : path, "closed" : closed, **kwargs})

class _path_cut_points(OpenSCADObject, Bosl2Mixin):
...
class _path_cut_points_recurse(OpenSCADObject, Bosl2Mixin):
...
class _path_cut_single(OpenSCADObject, Bosl2Mixin):
...
class _path_cuts_normals(OpenSCADObject, Bosl2Mixin):
...
class _path_plane(OpenSCADObject, Bosl2Mixin):
...
class _path_cuts_dir(OpenSCADObject, Bosl2Mixin):
...
class path_cut(OpenSCADObject, Bosl2Mixin):
...
class _path_cut_getpaths(OpenSCADObject, Bosl2Mixin):
...
class _cut_to_seg_u_form(OpenSCADObject, Bosl2Mixin):
...
class split_path_at_self_crossings(OpenSCADObject, Bosl2Mixin):
    def __init__(self, path=None, closed=None, eps=None, **kwargs):
       super().__init__("split_path_at_self_crossings", {"path" : path, "closed" : closed, "eps" : eps, **kwargs})

class _tag_self_crossing_subpaths(OpenSCADObject, Bosl2Mixin):
...
class polygon_parts(OpenSCADObject, Bosl2Mixin):
...
class _extreme_angle_fragment(OpenSCADObject, Bosl2Mixin):
...
class _assemble_a_path_from_fragments(OpenSCADObject, Bosl2Mixin):
...
class _assemble_path_fragments(OpenSCADObject, Bosl2Mixin):
