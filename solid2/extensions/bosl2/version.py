...
class bosl_required(OpenSCADObject, Bosl2Mixin):
    def __init__(self, version=None, **kwargs):
       super().__init__("bosl_required", {"version" : version, **kwargs})

class bosl_version(OpenSCADObject, Bosl2Mixin):
    def __init__(self, **kwargs):
       super().__init__("bosl_version", {**kwargs})

class bosl_version_num(OpenSCADObject, Bosl2Mixin):
    def __init__(self, **kwargs):
       super().__init__("bosl_version_num", {**kwargs})

class bosl_version_str(OpenSCADObject, Bosl2Mixin):
    def __init__(self, **kwargs):
       super().__init__("bosl_version_str", {**kwargs})

class _version_split_str(OpenSCADObject, Bosl2Mixin):
...
class version_to_list(OpenSCADObject, Bosl2Mixin):
    def __init__(self, version=None, **kwargs):
       super().__init__("version_to_list", {"version" : version, **kwargs})

class version_to_str(OpenSCADObject, Bosl2Mixin):
    def __init__(self, version=None, **kwargs):
       super().__init__("version_to_str", {"version" : version, **kwargs})

class version_to_num(OpenSCADObject, Bosl2Mixin):
    def __init__(self, version=None, **kwargs):
       super().__init__("version_to_num", {"version" : version, **kwargs})

class version_cmp(OpenSCADObject, Bosl2Mixin):
