...
class regular_polyhedron(OpenSCADObject, Bosl2Mixin):
...
class _stellate_faces(OpenSCADObject, Bosl2Mixin):
...
class _trapezohedron(OpenSCADObject, Bosl2Mixin):
