...
class skin(_OpenSCADObject, _Bosl2Mixin):
...
class linear_sweep(_OpenSCADObject, _Bosl2Mixin):
...
class _taperfunc(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, x=None, **kwargs):
       super().__init__("_taperfunc", {"x" : x, **kwargs})

class _ss_polygon_r(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, N=None, theta=None, **kwargs):
       super().__init__("_ss_polygon_r", {"N" : N, "theta" : theta, **kwargs})

class spiral_sweep(_OpenSCADObject, _Bosl2Mixin):
...
class path_sweep(_OpenSCADObject, _Bosl2Mixin):
...
class path_sweep2d(_OpenSCADObject, _Bosl2Mixin):
...
class sweep(_OpenSCADObject, _Bosl2Mixin):
...
class subdivide_and_slice(_OpenSCADObject, _Bosl2Mixin):
...
class slice_profiles(_OpenSCADObject, _Bosl2Mixin):
...
class rot_resample(_OpenSCADObject, _Bosl2Mixin):
...
class _dp_distance_array(_OpenSCADObject, _Bosl2Mixin):
...
class _dp_distance_row(_OpenSCADObject, _Bosl2Mixin):
...
class associate_vertices(_OpenSCADObject, _Bosl2Mixin):
...
class _get_texture(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, tex=None, n=None, m=None, **kwargs):
       super().__init__("_get_texture", {"tex" : tex, "n" : n, "m" : m, **kwargs})

class textured_linear_sweep(_OpenSCADObject, _Bosl2Mixin):
...
class textured_revolution(_OpenSCADObject, _Bosl2Mixin):
...
class textured_cylinder(_OpenSCADObject, _Bosl2Mixin):
