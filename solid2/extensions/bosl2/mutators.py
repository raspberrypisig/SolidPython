...
class cylindrical_extrude(OpenSCADObject, Bosl2Mixin):
...
class extrude_from_to(OpenSCADObject, Bosl2Mixin):
...
class path_extrude(OpenSCADObject, Bosl2Mixin):
