...
class cylindrical_extrude(_OpenSCADObject, _Bosl2Mixin):
...
class extrude_from_to(_OpenSCADObject, _Bosl2Mixin):
...
class path_extrude(_OpenSCADObject, _Bosl2Mixin):
