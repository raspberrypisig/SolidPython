...
extra_scad_include(f"{Path(__file__).parent.parent / '../libs/BOSL2/threading.scad'}", use_not_include=False)

class threaded_rod(OpenSCADObject, Bosl2Mixin):
...
class threaded_nut(OpenSCADObject, Bosl2Mixin):
...
class trapezoidal_threaded_rod(OpenSCADObject, Bosl2Mixin):
...
class trapezoidal_threaded_nut(OpenSCADObject, Bosl2Mixin):
...
class acme_threaded_rod(OpenSCADObject, Bosl2Mixin):
...
class acme_threaded_nut(OpenSCADObject, Bosl2Mixin):
...
class npt_threaded_rod(OpenSCADObject, Bosl2Mixin):
...
class buttress_threaded_rod(OpenSCADObject, Bosl2Mixin):
...
class buttress_threaded_nut(OpenSCADObject, Bosl2Mixin):
...
class square_threaded_rod(OpenSCADObject, Bosl2Mixin):
...
class square_threaded_nut(OpenSCADObject, Bosl2Mixin):
...
class ball_screw_rod(OpenSCADObject, Bosl2Mixin):
...
class generic_threaded_rod(OpenSCADObject, Bosl2Mixin):
...
class generic_threaded_nut(OpenSCADObject, Bosl2Mixin):
...
class thread_helix(OpenSCADObject, Bosl2Mixin):
