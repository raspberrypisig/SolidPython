...
class threaded_rod(_OpenSCADObject, _Bosl2Mixin):
...
class threaded_nut(_OpenSCADObject, _Bosl2Mixin):
...
class trapezoidal_threaded_rod(_OpenSCADObject, _Bosl2Mixin):
...
class acme_threaded_rod(_OpenSCADObject, _Bosl2Mixin):
...
class acme_threaded_nut(_OpenSCADObject, _Bosl2Mixin):
...
class npt_threaded_rod(_OpenSCADObject, _Bosl2Mixin):
...
class buttress_threaded_rod(_OpenSCADObject, _Bosl2Mixin):
...
class buttress_threaded_nut(_OpenSCADObject, _Bosl2Mixin):
...
class square_threaded_rod(_OpenSCADObject, _Bosl2Mixin):
...
class square_threaded_nut(_OpenSCADObject, _Bosl2Mixin):
...
class ball_screw_rod(_OpenSCADObject, _Bosl2Mixin):
...
class generic_threaded_rod(_OpenSCADObject, _Bosl2Mixin):
...
class generic_threaded_nut(_OpenSCADObject, _Bosl2Mixin):
...
class thread_helix(_OpenSCADObject, _Bosl2Mixin):
...
class trapezoidal_threaded_nut(_OpenSCADObject, _Bosl2Mixin):
