...
class round_corners(_OpenSCADObject, _Bosl2Mixin):
...
class _scalar_to_vector(_OpenSCADObject, _Bosl2Mixin):
...
class path_join(_OpenSCADObject, _Bosl2Mixin):
...
class _path_join(_OpenSCADObject, _Bosl2Mixin):
...
class offset_stroke(_OpenSCADObject, _Bosl2Mixin):
...
class _path_line_intersection(_OpenSCADObject, _Bosl2Mixin):
...
class _make_offset_polyhedron(_OpenSCADObject, _Bosl2Mixin):
...
class os_circle(_OpenSCADObject, _Bosl2Mixin):
...
class os_teardrop(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, r=None, cut=None, extra=None, check_valid=None, quality=None, steps=None, offset=None, **kwargs):
...
class os_chamfer(_OpenSCADObject, _Bosl2Mixin):
...
class os_smooth(_OpenSCADObject, _Bosl2Mixin):
...
class os_profile(_OpenSCADObject, _Bosl2Mixin):
...
class os_mask(_OpenSCADObject, _Bosl2Mixin):
...
class convex_offset_extrude(_OpenSCADObject, _Bosl2Mixin):
...
class _remove_undefined_vals(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, list=None, **kwargs):
       super().__init__("_remove_undefined_vals", {"list" : list, **kwargs})

class _rp_compute_patches(_OpenSCADObject, _Bosl2Mixin):
...
class rounded_prism(_OpenSCADObject, _Bosl2Mixin):
...
class join_prism(_OpenSCADObject, _Bosl2Mixin):
...
class _fix_angle_list(_OpenSCADObject, _Bosl2Mixin):
...
class _prism_fillet(_OpenSCADObject, _Bosl2Mixin):
...
class _prism_fillet_plane(_OpenSCADObject, _Bosl2Mixin):
...
class _prism_fillet_cyl(_OpenSCADObject, _Bosl2Mixin):
...
class _prism_fillet_sphere(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, name=None, R=None, bot=None, top=None, d=None, k=None, N=None, overlap=None, uniform=None, debug=None, **kwargs):
...
class _prism_fillet_prism(_OpenSCADObject, _Bosl2Mixin):
