...
class round_corners(OpenSCADObject, Bosl2Mixin):
...
class smooth_path(OpenSCADObject, Bosl2Mixin):
...
class path_join(OpenSCADObject, Bosl2Mixin):
...
class offset_stroke(OpenSCADObject, Bosl2Mixin):
...
class offset_sweep(OpenSCADObject, Bosl2Mixin):
...
class convex_offset_extrude(OpenSCADObject, Bosl2Mixin):
...
class rounded_prism(OpenSCADObject, Bosl2Mixin):
...
class bent_cutout_mask(OpenSCADObject, Bosl2Mixin):
...
class join_prism(OpenSCADObject, Bosl2Mixin):
...
class _scalar_to_vector(OpenSCADObject, Bosl2Mixin):
...
class _path_join(OpenSCADObject, Bosl2Mixin):
...
class _path_line_intersection(OpenSCADObject, Bosl2Mixin):
...
class _make_offset_polyhedron(OpenSCADObject, Bosl2Mixin):
...
class _struct_valid(OpenSCADObject, Bosl2Mixin):
...
class os_circle(OpenSCADObject, Bosl2Mixin):
...
class os_teardrop(OpenSCADObject, Bosl2Mixin):
    def __init__(self, r=None, cut=None, extra=None, check_valid=None, quality=None, steps=None, offset=None, **kwargs):
...
class os_chamfer(OpenSCADObject, Bosl2Mixin):
...
class os_smooth(OpenSCADObject, Bosl2Mixin):
...
class os_profile(OpenSCADObject, Bosl2Mixin):
...
class os_mask(OpenSCADObject, Bosl2Mixin):
...
class _remove_undefined_vals(OpenSCADObject, Bosl2Mixin):
    def __init__(self, list=None, **kwargs):
       super().__init__("_remove_undefined_vals", {"list" : list, **kwargs})

class _rp_compute_patches(OpenSCADObject, Bosl2Mixin):
...
class _fix_angle_list(OpenSCADObject, Bosl2Mixin):
...
class _prism_fillet(OpenSCADObject, Bosl2Mixin):
...
class _prism_fillet_plane(OpenSCADObject, Bosl2Mixin):
...
class _prism_fillet_cyl(OpenSCADObject, Bosl2Mixin):
...
class _prism_fillet_sphere(OpenSCADObject, Bosl2Mixin):
    def __init__(self, name=None, R=None, bot=None, top=None, d=None, k=None, N=None, overlap=None, uniform=None, debug=None, **kwargs):
...
class _prism_fillet_prism(OpenSCADObject, Bosl2Mixin):
