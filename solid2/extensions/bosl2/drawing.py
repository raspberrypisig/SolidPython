...
class stroke(OpenSCADObject, Bosl2Mixin):
...
class dashed_stroke(OpenSCADObject, Bosl2Mixin):
...
class arc(OpenSCADObject, Bosl2Mixin):
...
class helix(OpenSCADObject, Bosl2Mixin):
...
class turtle(OpenSCADObject, Bosl2Mixin):
...
class debug_polygon(OpenSCADObject, Bosl2Mixin):
...
class _normal_segment(OpenSCADObject, Bosl2Mixin):
...
class _turtle_command(OpenSCADObject, Bosl2Mixin):
