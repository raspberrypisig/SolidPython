...
class stroke(_OpenSCADObject, _Bosl2Mixin):
...
class dashed_stroke(_OpenSCADObject, _Bosl2Mixin):
...
class arc(_OpenSCADObject, _Bosl2Mixin):
...
class helix(_OpenSCADObject, _Bosl2Mixin):
...
class _normal_segment(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, p1=None, p2=None, **kwargs):
       super().__init__("_normal_segment", {"p1" : p1, "p2" : p2, **kwargs})

class turtle(_OpenSCADObject, _Bosl2Mixin):
...
class _turtle_command(_OpenSCADObject, _Bosl2Mixin):
...
class debug_polygon(_OpenSCADObject, _Bosl2Mixin):
