...
class chamfer_edge_mask(_OpenSCADObject, _Bosl2Mixin):
...
class chamfer_corner_mask(_OpenSCADObject, _Bosl2Mixin):
...
class chamfer_cylinder_mask(_OpenSCADObject, _Bosl2Mixin):
...
class rounding_edge_mask(_OpenSCADObject, _Bosl2Mixin):
...
class rounding_corner_mask(_OpenSCADObject, _Bosl2Mixin):
...
class rounding_angled_edge_mask(_OpenSCADObject, _Bosl2Mixin):
...
class rounding_angled_corner_mask(_OpenSCADObject, _Bosl2Mixin):
...
class rounding_cylinder_mask(_OpenSCADObject, _Bosl2Mixin):
...
class rounding_hole_mask(_OpenSCADObject, _Bosl2Mixin):
...
class teardrop_edge_mask(_OpenSCADObject, _Bosl2Mixin):
...
class teardrop_corner_mask(_OpenSCADObject, _Bosl2Mixin):
