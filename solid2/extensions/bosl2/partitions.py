...
class partition_cut_mask(OpenSCADObject, Bosl2Mixin):
...
class partition(OpenSCADObject, Bosl2Mixin):
...
class _partition_subpath(OpenSCADObject, Bosl2Mixin):
    def __init__(self, type=None, **kwargs):
       super().__init__("_partition_subpath", {"type" : type, **kwargs})

class _partition_cutpath(OpenSCADObject, Bosl2Mixin):
