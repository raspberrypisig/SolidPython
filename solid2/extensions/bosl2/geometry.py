...
class is_point_on_line(_OpenSCADObject, _Bosl2Mixin):
...
class line_closest_point(_OpenSCADObject, _Bosl2Mixin):
...
class line_from_points(_OpenSCADObject, _Bosl2Mixin):
...
class plane_normal(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, plane=None, **kwargs):
       super().__init__("plane_normal", {"plane" : plane, **kwargs})

class plane_offset(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, plane=None, **kwargs):
       super().__init__("plane_offset", {"plane" : plane, **kwargs})

class _general_plane_line_intersection(_OpenSCADObject, _Bosl2Mixin):
...
class _normalize_plane(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, plane=None, **kwargs):
       super().__init__("_normalize_plane", {"plane" : plane, **kwargs})

class plane_line_intersection(_OpenSCADObject, _Bosl2Mixin):
...
class plane_intersection(_OpenSCADObject, _Bosl2Mixin):
...
class are_points_on_plane(_OpenSCADObject, _Bosl2Mixin):
...
class _is_point_above_plane(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, plane=None, point=None, **kwargs):
       super().__init__("_is_point_above_plane", {"plane" : plane, "point" : point, **kwargs})

class circle_line_intersection(_OpenSCADObject, _Bosl2Mixin):
...
class _circle_or_sphere_line_intersection(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, r=None, cp=None, line=None, bounded=None, d=None, eps=None, **kwargs):
       super().__init__("_circle_or_sphere_line_intersection", {"r" : r, "cp" : cp, "line" : line, "bounded" : bounded, "d" : d, "eps" : eps, **kwargs})

class circle_circle_intersection(_OpenSCADObject, _Bosl2Mixin):
...
class circle_2tangents(_OpenSCADObject, _Bosl2Mixin):
...
class _noncollinear_triple(_OpenSCADObject, _Bosl2Mixin):
...
class polygon_line_intersection(_OpenSCADObject, _Bosl2Mixin):
...
class _merge_segments(_OpenSCADObject, _Bosl2Mixin):
...
class polygon_triangulate(_OpenSCADObject, _Bosl2Mixin):
...
class _triangulate(_OpenSCADObject, _Bosl2Mixin):
...
class _get_ear(_OpenSCADObject, _Bosl2Mixin):
...
class _none_inside(_OpenSCADObject, _Bosl2Mixin):
...
class is_polygon_clockwise(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, poly=None, **kwargs):
       super().__init__("is_polygon_clockwise", {"poly" : poly, **kwargs})

class clockwise_polygon(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, poly=None, **kwargs):
       super().__init__("clockwise_polygon", {"poly" : poly, **kwargs})

class ccw_polygon(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, poly=None, **kwargs):
       super().__init__("ccw_polygon", {"poly" : poly, **kwargs})

class reverse_polygon(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, poly=None, **kwargs):
       super().__init__("reverse_polygon", {"poly" : poly, **kwargs})

class reindex_polygon(_OpenSCADObject, _Bosl2Mixin):
...
class align_polygon(_OpenSCADObject, _Bosl2Mixin):
...
class are_polygons_equal(_OpenSCADObject, _Bosl2Mixin):
...
class _are_polygons_equal(_OpenSCADObject, _Bosl2Mixin):
...
class _is_polygon_in_list(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, poly=None, polys=None, **kwargs):
       super().__init__("_is_polygon_in_list", {"poly" : poly, "polys" : polys, **kwargs})

class ___is_polygon_in_list(_OpenSCADObject, _Bosl2Mixin):
...
class hull(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, points=None, **kwargs):
       super().__init__("hull", {"points" : points, **kwargs})

class _backtracking(_OpenSCADObject, _Bosl2Mixin):
...
class _remove_internal_edges(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, halfedges=None, **kwargs):
       super().__init__("_remove_internal_edges", {"halfedges" : halfedges, **kwargs})

class _find_first_noncoplanar(_OpenSCADObject, _Bosl2Mixin):
...
class is_polygon_convex(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, poly=None, eps=None, **kwargs):
       super().__init__("is_polygon_convex", {"poly" : poly, "eps" : eps, **kwargs})

class convex_distance(_OpenSCADObject, _Bosl2Mixin):
...
class _GJK_distance(_OpenSCADObject, _Bosl2Mixin):
...
class convex_collision(_OpenSCADObject, _Bosl2Mixin):
    def __init__(self, points1=None, points2=None, eps=None, **kwargs):
       super().__init__("convex_collision", {"points1" : points1, "points2" : points2, "eps" : eps, **kwargs})

class _GJK_collide(_OpenSCADObject, _Bosl2Mixin):
